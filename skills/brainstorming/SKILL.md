...
- Explore the current structure before proposing changes. Parent/orchestrators SHOULD delegate broad structure and pattern discovery to `scout`. Follow existing patterns.
